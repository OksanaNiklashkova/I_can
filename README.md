...
* В рамках учебного проекта сервер развернут на базе Яндекс.Cloud по адресу: http://158.160.187.231/
...
```
git clone https://github.com/OksanaNiklashkova/I_can.git
```
...
* POSTGRES_DB - название базы данных, например, i_can_db
...
Например:
http://158.160.187.231/admin/
http://158.160.187.231/redoc/
http://158.160.187.231/swagger/
