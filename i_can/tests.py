...
class HabitAPITestCase(APITestCase):
    def setUp(self):
        ...
        self.good_habit = Habit.objects.create(action='выучить 5 английских слов', user=self.user, periodicity=1,
                                               start_time='19:50:00', related_habit=self.pleasant_habit)
    ...
    def test_habit_retrieve(self):
        ...
        self.assertEqual(
            data.get('action'), self.good_habit.action
        )
    ...
    def test_habit_list(self):
        ...
        self.assertEqual(
            data['results'][0]['action'], 'выучить 5 английских слов'
        )
    ...
    def test_habit_update(self):
        ...
        self.assertEqual(
            result.get('action'), 'сделать 20 приседаний'
        )
